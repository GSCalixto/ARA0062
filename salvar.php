      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Minhas Idéias</h1>
            <span class="subheading">Um pequeno compilado de idéias</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Main Content -->
    <div class="container">
        <div class="row">
            ...
            if (isset($_GET["id"])) {
                $id = $_GET["id"];
                $sql = "update blog set titulo='$titulo',  corpo='$texto' where id='$id' ";
            }else {
                $sql = "INSERT INTO `blog` (`id`, `titulo`, `corpo`) VALUES (NULL, '$titulo', '$texto')";    
            }
            ...
            echo "<h1 class='col-12'> Foi incluído/atualizado $contador registro </h1>";

            echo "<a  class='col-12' href='index.php'>Voltar </a>";
